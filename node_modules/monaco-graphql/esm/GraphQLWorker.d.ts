...
export declare class GraphQLWorker {
    ...
    doHover(uri: string, position: monaco.Position): Promise<{
        content: import("vscode-languageserver-types").MarkedString[] | import("vscode-languageserver-types").MarkupContent | import("vscode-languageserver-types").MarkedString | undefined;
        range: monaco.IRange;
    } | null>;
