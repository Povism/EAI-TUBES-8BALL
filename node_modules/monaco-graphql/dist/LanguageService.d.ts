...
type SchemaCacheItem = Omit<SchemaConfig, 'schema'> & {
...
export declare class LanguageService {
    ...
    getHover: (uri: string, documentText: string, position: IPosition, options?: HoverConfig) => import("vscode-languageserver-types").MarkedString[] | import("vscode-languageserver-types").MarkupContent | import("vscode-languageserver-types").MarkedString | undefined;
