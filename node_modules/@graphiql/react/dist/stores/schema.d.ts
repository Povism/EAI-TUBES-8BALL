...
type CreateSchemaSlice = (initial: Pick<SchemaSlice, 'inputValueDeprecation' | 'introspectionQueryName' | 'onSchemaChange' | 'schemaDescription'>) => StateCreator<SlicesWithActions, [
], [
], SchemaSlice & {
