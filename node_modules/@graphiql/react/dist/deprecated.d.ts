...
export declare function useEditorContext(): {
    ...
    headerEditor?: MonacoEditor | undefined;
    queryEditor?: MonacoEditor | undefined;
    responseEditor?: MonacoEditor | undefined;
    variableEditor?: MonacoEditor | undefined;
    addTab: () => void;
    changeTab: (index: number) => void;
    moveTab: (newOrder: import('./utility/tabs').TabState[]) => void;
    closeTab: (index: number) => void;
    updateActiveTabValues: (partialTab: Partial<Omit<import('./utility/tabs').TabState, "id" | "hash" | "title">>) => void;
...
export declare function usePluginContext(): {
    ...
    setVisiblePlugin: (plugin?: import('.').GraphiQLPlugin | string | null) => void;
};
/**
 * @deprecated Use `useGraphiQLActions` and `useGraphiQL` hooks instead.
 */
 ...
 */
export declare const useStorage: () => import('@graphiql/toolkit', { with: { "resolution-mode": "import" } }).StorageAPI;
/**
 * @deprecated Use `const storage = useGraphiQL(state => state.storage)` instead.
 */
export declare const useStorageContext: () => import('@graphiql/toolkit', { with: { "resolution-mode": "import" } }).StorageAPI;
/**
 * @deprecated Use `useGraphiQLActions` and `useGraphiQL` hooks instead.
 */
